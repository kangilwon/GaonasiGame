			...
			<div style="width: 100%;">
				<form name="form1" method="post" action="/yoplle/insert.do">
					...
					<div class="tableIndexWidth">
						...
						<div class="tableIndexDt">
							<textarea class="tableInDt" name="NOTI_CONTENT" id="content"
								rows="10" cols="80" placeholder="내용을 입력해주세요"></textarea>
						</div>
					</div>
					...
					<div style="width: 100%; margin-bottom: 10%; margin-top: 3%">
						...
						<!-- 추가 -->
						<strong class="tableTextString">업로드</strong>
						 <span
							class="tableInDt"> <input type="file" id="InputFile"
							name="file" />
						</span>
						 <span style="margin: 0 12% 0 7% ;"></span>
						<!--  -->
						
						<strong class="tableTextString">작성자</strong> <span
							class="tableInDt4">요플레</span>
						<input type="hidden" name="EMP_NO" id="writer" size="80" value="1"
							class="tableInDt2">
					</div>
