...
public class GamePanel4 extends JPanel implements ActionListener {
	...
	static final int SCREEN_WIDTH = 500; // 윈도우 창의 가로 크기
	static final int SCREEN_HEIGHT = 500; // 윈도우 창의 세로 크기
	static final int UNIT_SIZE = 25; // 뱀과 사과의 크기 (윈도우 창의 격자 하나의 크기)
	static final int GAME_UNITS = (SCREEN_WIDTH * SCREEN_HEIGHT) / UNIT_SIZE;
	static final int DELAY = 25; // 뱀의 이동속도
	final int x[] = new int[GAME_UNITS];
	final int y[] = new int[GAME_UNITS];
	int bodyparts = 12; // 뱀의 기본 길이 설정
